...
| 항목 | 현재 상태 | 개선 방향 |
|------|---------|---------|
| Positive sample 부족 | 807개 식당 수집 후에도 couple 25개·business_meal 17개·business_drink 13개 — 권장(30개) 미달 | 카카오맵 리뷰는 관계 맥락을 잘 명시하지 않아 수집량을 늘려도 비율이 크게 개선되기 어려움. human-labeled 검증셋 확보가 근본 해결책 |
